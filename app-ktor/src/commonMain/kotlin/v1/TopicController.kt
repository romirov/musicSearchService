...
suspend fun ApplicationCall.createTopic(appSettings: MssAppSettings) =
    processV2<TopicCreateRequest, TopicCreateResponse>(appSettings, clCreate, "createTopic")
...
suspend fun ApplicationCall.readTopic(appSettings: MssAppSettings) =
    processV2<TopicReadRequest, TopicReadResponse>(appSettings, clRead, "readTopic")
...
suspend fun ApplicationCall.updateTopic(appSettings: MssAppSettings) =
    processV2<TopicUpdateRequest, TopicUpdateResponse>(appSettings, clUpdate, "updateTopic")
...
suspend fun ApplicationCall.deleteTopic(appSettings: MssAppSettings) =
    processV2<TopicDeleteRequest, TopicDeleteResponse>(appSettings, clDelete, "deleteTopic")
...
suspend fun ApplicationCall.searchTopic(appSettings: MssAppSettings) =
    processV2<TopicSearchRequest, TopicSearchResponse>(appSettings, clSearch, "searchTopic")
